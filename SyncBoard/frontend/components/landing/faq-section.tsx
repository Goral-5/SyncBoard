...
const faqs = [
  {
    q: "What is SyncBoard?",
    a: "SyncBoard is a low-latency, real-time collaborative workspace for distributed engineering teams to architect systems, map workflows, and align on technical decisions on a shared infinite canvas."
  },
  {
    q: "Do I need to sign up to use SyncBoard?",
    a: "Yes. You can open a workspace, invite collaborators, and start working in real time once your team is authenticated and routed into the board session."
  },
  {
    q: "How does real-time collaboration work?",
    a: "SyncBoard uses room-scoped Socket.io event broadcasting so shape updates, presence, and cursor movement are synchronized across collaborators with low latency."
  },
  {
    q: "Can multiple people work on the same board at once?",
    a: "Yes. Multiple users can draw, edit, and review the same canvas together, making it ideal for engineering reviews, architecture sessions, and whiteboarding under load."
  },
  {
    q: "Is SyncBoard built for enterprise use?",
    a: "Yes. The platform is designed around concurrency, room isolation, and persistent workspaces so distributed teams can collaborate reliably at scale."
  },
  {
    q: "Do I need to install anything?",
    a: "No. SyncBoard is delivered through the browser so your team can launch sessions quickly without local setup or desktop dependencies."
  },
  {
    q: "Can I share my workspace with others?",
    a: "Absolutely. Every room is shareable through a unique workspace link so teammates can join quickly and collaborate in the same session context."
  },
  {
    q: "Is my data secure?",
    a: "Yes. Workspaces are isolated by room identity and protected by authenticated access patterns, keeping collaboration secure and role-aware."
  },
  {
    q: "Is SyncBoard open source?",
    a: "Yes. SyncBoard ships as a clean MERN-based application architecture with extensible room, auth, and real-time collaboration services for engineering teams."
  },
  {
    q: "Who is SyncBoard best suited for?",
    a: "SyncBoard is ideal for architecture teams, platform engineers, product squads, and distributed organizations that need clear system design collaboration in real time."
  }
];
