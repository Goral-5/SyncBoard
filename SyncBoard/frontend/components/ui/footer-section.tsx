...
function Footerdemo() {
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="relative">
            ...
            <p className="mb-6 text-muted-foreground">
              Receive product updates, launch news, and collaboration announcements.
            </p>
          ...
          <div>
            ...
            <address className="space-y-2 text-sm not-italic">
              <p>City, Country</p>
              <p>Website: example-company.com</p>
              <p>Email: hello@example-company.com</p>
            </address>
          </div>
          <div className="relative">
  ...
  <TooltipProvider>
    <Tooltip>
      ...
      <TooltipContent>
        <p>Instagram link coming soon</p>
      </TooltipContent>
    </Tooltip>
  </TooltipProvider>
